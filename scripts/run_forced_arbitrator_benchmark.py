...
MODES = ["BASELINE", "PASSIVE", "FP_RESCUE_JUDGE", "FN_RESCUE_JUDGE", "COMBINED"]
...
def run_benchmark():
    ...
    for mode in MODES:
        ...
        args_en = {
            ...
            "all_cols": cols_en, "miner": miner, "court": court,
        ...
        args_fr = {
            ...
            "all_cols": cols_fr, "miner": miner, "court": court,
        ...
        llm_o_en = {k: v for k, v in ov_en.items() if "forced" in str(v.get("override", "")) or "groq_passive" in str(v.get("override", ""))}
        llm_o_fr = {k: v for k, v in ov_fr.items() if "forced" in str(v.get("override", "")) or "groq_passive" in str(v.get("override", ""))}
